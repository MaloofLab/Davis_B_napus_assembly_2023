...
def pltsv(ax, alignments, chrs, v, chrgrps, chrlengths, indents, S, cfg, itx, maxl):
    ...
    legenddict = {'SYN': adsynlab, 'INV': adinvlab, 'TRANS': adtralab, 'DUP': adduplab,
                  'TRANS-A01': adtralab, 'TRANS-A02': adtralab, 'TRANS-A03': adtralab,
                  'TRANS-A04': adtralab, 'TRANS-A05': adtralab, 'TRANS-A06': adtralab,
                  'TRANS-A07': adtralab, 'TRANS-A08': adtralab, 'TRANS-A09': adtralab,
                  'TRANS-A10': adtralab, 'TRANS-C01': adtralab, 'TRANS-C02': adtralab,
                  'TRANS-C03': adtralab, 'TRANS-C04': adtralab, 'TRANS-C05': adtralab,
                  'TRANS-C06': adtralab, 'TRANS-C07': adtralab, 'TRANS-C08': adtralab,
                  'TRANS-C09': adtralab}
    for s in range(len(alignments)):
        ...
        labdict = {'SYN': 'Syntenic', 'INV': 'Inversion', 'TRANS': 'Translocation', 'DUP': 'Duplication',
                   'TRANS-A01': 'Translocation', 'TRANS-A02': 'Translocation', 'TRANS-A03': 'Translocation', 'TRANS-A04': 'Translocation',
                   'TRANS-A05': 'Translocation', 'TRANS-A06': 'Translocation', 'TRANS-A07': 'Translocation', 'TRANS-A08': 'Translocation',
                   'TRANS-A09': 'Translocation', 'TRANS-A10': 'Translocation', 'TRANS-C01': 'Translocation', 'TRANS-C02': 'Translocation',
                   'TRANS-C03': 'Translocation', 'TRANS-C04': 'Translocation', 'TRANS-C05': 'Translocation', 'TRANS-C06': 'Translocation',
                   'TRANS-C07': 'Translocation', 'TRANS-C08': 'Translocation', 'TRANS-C09': 'Translocation'}
