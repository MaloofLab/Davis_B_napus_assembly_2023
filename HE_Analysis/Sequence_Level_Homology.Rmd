...
Pseudo_napus_Coverage <- Coverage_Readin("Coverages/Sequence/pseudo_napus_coverage.tsv")
DaAe_Coverage <- Coverage_Readin("Coverages/Sequence/DaAe_coverage.tsv")
```
...
for (i in chroms) {
  ...
  ggsave(paste0("Coverage_Plots_20220607/",i,".png"))
}
```
...
Pseudo_napus_Coverage <- Coverage_Readin("Coverages/Sequence/pseudo_napus_coverage.tsv")
DaAe_Coverage <- Coverage_Readin("Coverages/Sequence/DaAe_coverage.tsv")
ZS11_Coverage <- Coverage_Readin("Coverages/Sequence/ZS11_coverage.tsv")
Darmor_Bzh_V10_Coverage <- Coverage_Readin("Coverages/Sequence/Darmor-Bzh_V10_coverage.tsv")
```
...
for (i in chroms) {
  ...
  ggsave(paste0("Coverage_Plots_20220610/",i,".png"), width = 10, height = 10)
}
