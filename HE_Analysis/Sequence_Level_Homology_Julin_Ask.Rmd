...
Coverage_Readin <- function(filename){
  df <- read_delim(filename,
    ...
    mutate(Genome_Average = mean(Adjusted_Coverage, na.rm = T),
...
for (i in chroms) {
  ...
  ggsave(paste0("Coverage_Plots_20220927/",i,".png"))
}
```
...
for (i in chroms) {
  ...
  ggsave(paste0("Coverage_Plots_20220927/",i,".png"), width = 10, height = 10)
}

save(Clustered_All, All_Positions, file = "Julin_Coverages_and_Positions.RData")
```
...
for (i in chroms) {
  ...
  ggsave(
    paste0("Combined_Coverage_Plots_20220927/", i, ".png"),
    width = 10,
    height = 10
  )
}
...
for (i in chroms) {
  ...
  ggsave(
    paste0("Test_Combined_Coverage_Plots_20220927/", i, ".png"),
    width = 10,
    height = 10
  )
}
